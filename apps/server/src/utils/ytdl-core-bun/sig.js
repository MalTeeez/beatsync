...
const TCE_SIGN_FUNCTION_REGEXP =
...
const TCE_SIGN_FUNCTION_ACTION_REGEXP =
...
const extractDecipherFunc = (body, name, code) => {
  try {
    ...
    if (sigFunctionMatcher && sigFunctionActionsMatcher && code) {
      resultFunc =
        "var " + DECIPHER_FUNC_NAME + "=" + sigFunctionMatcher[0] + sigFunctionActionsMatcher[0] + code + ";\n";
