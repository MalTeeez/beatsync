...
export const handleExternalPause: HandlerFunction<
  ExtractWSRequestFrom["EXTERNAL_PAUSE"]
> = async ({ ws, message, server }) => {
  ...
  room.updatePlaybackScheduleExternalPause(message, serverTimeToExecute);
